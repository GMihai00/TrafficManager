...
\indent
Figure ~\ref{fig:Timer Increase/Decrease Impact} illustrates how 
we actually handle each combination of those scenarios. Like so 
we can achive the desired traffic flow described above while 
minimizing the waiting time as much as we can. Also, I have to mention 
that the way we actually determine if enough vehicles passed is by 
