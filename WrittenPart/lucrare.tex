...
\begin{figure}[h!]
    \includegraphics[width=\textwidth]{TrafficJam.jpg}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addlegendentry{Image preprocessing enabled}
            \addplot[color=blue]table {testData/dataMovementRecognition.txt};
            \addlegendentry{Image preprocessing disabled}
        \end{axis}
    \end{tikzpicture}
...
\begin{lstlisting}[caption={Connection template}, language = C++][H]
    template <typename T>
    class Connection
...
The connection is responsible for reading and writing messages.
It acts like a middle point between the client and the server. It 
shared a queue of incoming messages and a condition variable with 
any of the other to classes so that it can notify the owner that a 
new message has arrived. 
\pagebreak

\begin{lstlisting}[caption={Server template}, language = C++][H]
    template<typename T>
    class Server
    {
    protected:
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[color=red]table {testData/dataYOLO.txt};
            \addlegendentry{YOLO Performance}
            \addplot[color=blue]table {testData/dataTensorFlow.txt};
            \addlegendentry{TensorFlow Performance}
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            xlabel={$average-waiting-time$},
            ylabel={$cars-passed$},
        ]
            \addplot[color=red]table {testData/carTesting/noOptimizers/20230610_132908.txt};
            \addlegendentry{System performance}
            \addplot[color=blue]table {testData/carTesting/Optimizers/20230610_132406.txt};
            \addlegendentry{Normal traffic performance}
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[color=red]table {testData/carTesting/noOptimizers/20230610_132908.txt};
            \addlegendentry{System performance in bad weather}
            \addplot[color=blue]table {testData/carTesting/Optimizers/Rain/20230610_132407.txt};
            \addlegendentry{Normal traffic performance}
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[color=green]table {testData/carTesting/Optimizers/NoDSRC/20230610_175819.txt};
            \addlegendentry{Sys. performance, no DSRC support}
            \addplot[color=blue]table {testData/carTesting/Optimizers/20230610_132406.txt};
            \addlegendentry{System performance}
        \end{axis}
    \end{tikzpicture}
