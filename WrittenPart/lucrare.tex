...
It atcs like a middle point between the client and the server. It 
shared a queue of incoming messages and an condition variable with 
...
scenario when our sistem will not perform optimally, so in Fig 
~\ref{fig:Optimizer vs no optimizers in rain} we presented 
the performance differce when it's raining. As you can see,
